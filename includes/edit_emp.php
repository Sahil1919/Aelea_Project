...
<div class="content-i">
    <div class="content-box">
        <div class="element-wrapper">
            ...
            {
                $qry = mysqli_query($connection, "SELECT * FROM emp_login where id='$id'") or die("select query fail" . $connection->mysqli_error());
            $count = 0;
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group"><label for="">Employee Code</label>
                                    <input class="form-control" value="<?php echo $emp_code; ?>" name="emp_code"
                                        placeholder="Employee Code" type="text" readonly>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group"><label for="">Name</label>
                                    <input class="form-control" value="<?php echo $emp_name; ?>" name="Name"
                                        placeholder="Name" type="text">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group"><label for="">Email ID</label>
                                    <input class="form-control" value="<?php echo $email_id; ?>" name="emailid"
                                        placeholder="Email ID" type="email">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group"><label for="">Mobile No.</label>
                                    <input class="form-control" value="<?php echo $emp_mob; ?>" name="mobile"
                            ...
                            <div class="col-sm-3">
                                ...
                                <input class="form-control" value="<?php echo $user_role;?>" readonly>
                                </div>
                            </div>

                            <div class="col-sm-3">
                                <div class="form-group"><label for="">Reporting To</label>
                                <input class="form-control" value="<?php echo $app_code_obj->getName($report_to);?>" readonly>
                                </div>
                            </div>
                            <!-- <div class="col-sm-3">
                                ...
                                <div class="form-group"><label for="">Reporting To</label>
                                    <select id="rm_id" name="report_to" class="form-control select2">
                                        <option>
                                            <?php 
                                            if ($report_to==''){echo '';}
                                            else {echo $app_code_obj->getName($report_to); }?>
                                        </option>
                                        <?php

                                        $qry = mysqli_query($connection, "SELECT * FROM emp_login where user_role IN ('reporting manager','management','admin') and status='1'") or die("select query fail" . $connection->mysqli_error());
                                        $count = 0;
                                        while ($row = mysqli_fetch_assoc($qry)) {
                                            $count = $count + 1;

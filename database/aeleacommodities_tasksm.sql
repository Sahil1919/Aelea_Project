...
--
-- Database: `aeleacommodities_tasksm`
--
...
CREATE TABLE `approval_list` (
  `srno` int(10) NOT NULL PRIMARY KEY,
...
(1, 'emp_001', 'Aelea Commodities', 'admin', 'admin', 1, '0000-00-00 00:00:00', 'admin', 'hr.png', 'marketing@aeleacommodities.com', '9511225744', '');
...
--
-- Structure for view `pdf_views` exported as a table
--
DROP TABLE IF EXISTS `pdf_views`;
CREATE TABLE`pdf_views`(
    `emp_code` varchar(255) COLLATE latin1_swedish_ci NOT NULL,
    `emp_name` varchar(255) COLLATE latin1_swedish_ci NOT NULL,
    `user_id` varchar(255) COLLATE latin1_swedish_ci NOT NULL,
    `user_role` varchar(255) COLLATE latin1_swedish_ci NOT NULL,
    `email_id` varchar(255) COLLATE latin1_swedish_ci NOT NULL,
    `emp_mob` varchar(255) COLLATE latin1_swedish_ci NOT NULL,
    `emp_id` int(11) DEFAULT NULL,
    `task` text COLLATE utf8_general_ci DEFAULT NULL,
    `assignby` varchar(255) COLLATE latin1_swedish_ci DEFAULT NULL,
    `work_assign_date` datetime DEFAULT NULL,
    `work_due_date` datetime DEFAULT NULL,
    `work_com_date` datetime DEFAULT NULL,
    `status` varchar(255) COLLATE latin1_swedish_ci DEFAULT NULL,
    `remark` text COLLATE utf8_general_ci DEFAULT NULL,
    `Achievements` text COLLATE latin1_swedish_ci DEFAULT NULL,
    `Benefits` text COLLATE latin1_swedish_ci DEFAULT NULL,
    `attachments` varchar(255) COLLATE latin1_swedish_ci DEFAULT NULL
);

-- --------------------------------------------------------

--
-- Structure for view `pdf_views1` exported as a table
--
...
CREATE TABLE`pdf_views1`(
    ...
    `assignby` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
    `work_assign_date` datetime(6) NOT NULL,
    `work_due_date` datetime(6) DEFAULT NULL,
    `work_com_date` datetime(6) DEFAULT NULL,
...
--
ALTER TABLE `approval_list`
  MODIFY `srno` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

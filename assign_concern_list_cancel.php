...
//    $oldPSWD = $_POST['oldPSWD'];
    ...
    $query = "INSERT INTO `assign_concer`( `emp_id`, `task`, `assignby`, `task_doc`, `work_assign_date`, `status`)";
...
<!--                               <th>Edit</th>-->
        ...
        <tbody>
                                 <?php
                 $qry = mysqli_query($connection, "SELECT * FROM assign_concern where status='Cancel'") or die("select query fail" . mysqli_error());
                 $count = 0;
                 ...
                 while ($row = mysqli_fetch_assoc($qry)) {
                   ...
                   <td>
                    ...
                    <td><?php echo $remark;?> </td>
                     <?php 
                         if ($work_com_date!=NULL){
                             $work_status="Completed";
                             echo "<td><a style='width: 100%;' class='btn btn-success' href='#'>$work_status</a></td>";
                         }
                         else{
                             $work_status="Pending";
                             echo "<td><a style='width: 100%;' class='btn btn-warning' href='#'>$work_status</a></td>";
                         }
                     ?>
                    </td> 
